  ...
  <div class="login-container bgImg content">
    <div class="layout">
      <a-form-model
        ...
        ref="loginForm"
      >
        <!-- <div class="title">leapting video</div> -->
        <div class="title">丽天机器人云平台</div>
        ...
        <a-form-item style="margin-top:-7px">
          <a-button type="primary" block size="large" class="login" :loading="loading" @click="toLogin">
            登录
          </a-button>
        </a-form-item>
        <a-form-item style="margin-top:-7px">
...
.login-container {
  ...
  width: 100%;
  min-height: 100vh;
  background: url('~@/assets/login/login-background.webp') no-repeat 100% 100%;
  background-position: 50%;
  background-attachment: fixed;
  padding-bottom: 40px;
  overflow: auto;
  background-size: cover;
  // background-image: url('~@/assets/login/login-background.jpeg');
  .layout {
    // width: 55%;
    // min-width: 900px;
    // margin: 0 auto;
